...
Source=scipy.io.loadmat('CADW/C--DWA(4)/Caltech.mat')
Target1=scipy.io.loadmat('CADW/C--DWA(4)/Dslr(4).mat')      # first target
Target2 =scipy.io.loadmat('CADW/C--DWA(4)/Webcam(4).mat')      # second target
Target3 =scipy.io.loadmat('CADW/C--DWA(4)/Amazon(t).mat')      # third target
...
scipy.io.savemat('CADW/CDWA.mat',{'Xs':data_source, 'D':data_target1,
                                  'W': data_target2, 'A':data_target3})
...
for param_beta in range(len(beta)):
    for param_gama in range(len(gama)):
        ...
        scipy.io.savemat('CADW/C--DWA(4)/beta_gama2.mat',
