...
Caltech=scipy.io.loadmat('CADW/C--DW(4)/Caltech.mat')
Dslr=scipy.io.loadmat('CADW/C--DW(4)/Dslr(4).mat')      #第一个目标域
Webcam=scipy.io.loadmat('CADW/C--DW(4)/Webcam(4).mat')      #第二个目标域
...
for param_beta in range(len(beta)):
    for param_gama in range(len(gama)):
        ...
        scipy.io.savemat('CADW/C--DW(4)/beta_gama2.mat',
