...
classnum_PIE05=20; classnum_PIE07=9; classnum_PIE29=9
M=2   #目标域个数

PIE05=scipy.io.loadmat('PIE/05/PIE05.mat')
PIE07=scipy.io.loadmat('PIE/05/07,29/PIE07.mat')      #第一个目标域
PIE29=scipy.io.loadmat('PIE/05/07,29/29.mat')      #第二个目标域

data_PIE05=PIE05['Xs']; data_PIE07=PIE07['Xt']; data_PIE29=PIE29['Xt']
label_05=PIE05['Ys']; label_07=PIE07['Yt']; label_29=PIE29['Yt']
...
label_PIE05=[]; label_PIE07=[]; label_PIE29=[]
