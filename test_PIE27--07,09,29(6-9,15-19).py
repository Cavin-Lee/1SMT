...
classnum_PIE27=20; classnum_PIE07=9; classnum_PIE09=9; classnum_PIE29=9
M=3   #目标域个数
...
PIE29=scipy.io.loadmat('PIE/27/07,09,29/PIE29(6-9,15-19).mat')     #第三个目标域
...
for param_beta in range(len(beta)):
    for param_gama in range(len(gama)):
        ...
        scipy.io.savemat('PIE/27/07,09,29/beta_gama42.mat',
