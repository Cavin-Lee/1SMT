...
classnum_PIE05=20; classnum_PIE09=9; classnum_PIE29=9
M=2   #目标域个数

PIE05=scipy.io.loadmat('PIE/05/PIE05.mat')
PIE09=scipy.io.loadmat('PIE/05/09,29/PIE09(1).mat')      #第一个目标域
PIE29=scipy.io.loadmat('PIE/05/09,29/29.mat')      #第二个目标域

data_PIE05=PIE05['Xs']; data_PIE09=PIE09['Xt']; data_PIE29=PIE29['Xt']
label_05=PIE05['Ys']; label_09=PIE09['Yt']; label_29=PIE29['Yt']
...
label_PIE05=[]; label_PIE09=[]; label_PIE29=[]
...
VT = [np.mat(np.random.random((classnum_PIE09, classnum_PIE05))),
...
for param_eta in range(len(eta)):
    ...
    for m in range(Maxiter):
        W_PIE09 = target_domain.target_WTj(data_PIE09, U_PIE09_tar, W_PIE05, VT_tar[0], V_tar[0],
                                           D_tar, Lambda_PIE09, gama[0], beta)
        W_PIE29 = target_domain.target_WTj(data_PIE29, U_PIE29_tar, W_PIE05, VT_tar[1], V_tar[1],
        ...
        VT_tar[0] = target_domain.Source_Target_VTj(W_PIE09, W_PIE05, beta, eta[param_eta])
        VT_tar[1] = target_domain.Source_Target_VTj(W_PIE29, W_PIE05, beta, eta[param_eta])
        WT = [W_PIE09, W_PIE29]
        try:
