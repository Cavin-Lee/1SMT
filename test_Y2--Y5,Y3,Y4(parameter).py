...
Source=scipy.io.loadmat('YaleB/3/Y2--Y5,Y3,Y4,Y1/Y2.mat')
Target1=scipy.io.loadmat('YaleB/3/Y2--Y5,Y3,Y4,Y1/Y5.mat')      # first target
Target2 =scipy.io.loadmat('YaleB/3/Y2--Y5,Y3,Y4,Y1/Y3.mat')      # second target
Target3 =scipy.io.loadmat('YaleB/3/Y2--Y5,Y3,Y4,Y1/Y4.mat')      # third target
...
data_target3=pca_t2.fit_transform(data_target3)

scipy.io.savemat('YaleB/3/Y2--Y5,Y3,Y4,Y1/Y2534_100.mat',{'Xs':data_source, 'X5':data_target1,
...
gama = 0.1
eta =0.1
r = [2,5,8,10,15,20,25,30,35,40]

NMI_Y1_parameter = np.mat(np.zeros((10,1)))
NMI_Y3_parameter = np.mat(np.zeros((10,1)))
NMI_Y4_parameter = np.mat(np.zeros((10,1)))
RI_Y1_parameter = np.mat(np.zeros((10,1)))
RI_Y3_parameter = np.mat(np.zeros((10,1)))
RI_Y4_parameter = np.mat(np.zeros((10,1)))
...
for param_r in range(len(r)):
    ...
    NMI_Y1_parameter[param_r, 0] = round(NMI_t1, 4)
    RI_Y1_parameter[param_r, 0] = round(RI_t1, 4)
    ...
    # print('RI：', round(RI_t2, 4))
    NMI_Y3_parameter[param_r, 0] = round(NMI_t2, 4)
    RI_Y3_parameter[param_r, 0] = round(RI_t2, 4)
    ...
    NMI_Y4_parameter[param_r, 0] = round(NMI_t3, 4)
    RI_Y4_parameter[param_r, 0] = round(RI_t3, 4)

    print(NMI_Y1_parameter)
    print(NMI_Y3_parameter)
    print(NMI_Y4_parameter)

    scipy.io.savemat('YaleB/3/Y2--Y5,Y3,Y4,Y1/2--534(NMI,RI)_r2.mat',
                     {'NMI_Y5': NMI_Y1_parameter, 'RI_Y5': RI_Y1_parameter,
                      'NMI_Y3': NMI_Y3_parameter, 'RI_Y3': RI_Y3_parameter,
                      'NMI_Y4': NMI_Y4_parameter, 'RI_Y4': RI_Y4_parameter})